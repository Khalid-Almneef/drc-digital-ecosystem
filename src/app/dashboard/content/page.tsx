...
const BASE_COLLECTION_CONFIGS: CollectionConfig[] = [
  {
    page: "main",
    key: "home.heroBanners",
    title: "Hero Banners",
    description: "Premium image-backed cards shown in the homepage hero.",
    defaults: toCollectionItems(DEFAULT_HOME_HERO_BANNERS),
    fields: [
      { key: "eyebrowEn", label: "Eyebrow (EN)" },
      { key: "eyebrowAr", label: "Eyebrow (AR)" },
      { key: "titleEn", label: "Title (EN)", type: "textarea" },
      { key: "titleAr", label: "Title (AR)", type: "textarea" },
  ...
  {
    page: "main",
    key: "home.featureSpotlights",
    title: "Homepage Story Blocks",
    description: "Image-backed feature blocks used to tell the club story on the homepage.",
    defaults: toCollectionItems(DEFAULT_HOME_FEATURE_SPOTLIGHTS),
    fields: [
