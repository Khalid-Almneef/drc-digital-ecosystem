...
(() => {
  try {
    ...
    const primaryRgb = toRgb(palette.primary);
    const secondaryRgb = toRgb(palette.secondary);
    ...
    document.documentElement.style.setProperty("--border", rgba(primaryRgb, activeTheme === "light" ? 0.1 : 0.08));
    document.documentElement.style.setProperty("--border-highlight", borderHighlight + "55");
    document.documentElement.style.setProperty("--hud-line", rgba(primaryRgb, activeTheme === "light" ? 0.1 : 0.12));
    document.documentElement.style.setProperty("--prop-wash", rgba(activeTheme === "light" ? secondaryRgb : primaryRgb, activeTheme === "light" ? 0.05 : 0.06));
