                    ...
                    <div className="space-y-2">
                      {group.accounts.map(({ key, color }) => {
                        ...
                        return (
                          ...
                          >
                            <div className={`w-9 h-9 rounded-lg bg-gradient-to-br ${color} flex items-center justify-center text-[10px] font-bold text-white shadow-lg shadow-black/10 shrink-0`}>
